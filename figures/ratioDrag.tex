...
\begin{picture}(7180.00,4300.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \csname LTb\endcsname%%
      \put(6122,3856){\makebox(0,0)[r]{\strut{}$Ca=1 \times 10^{0}$}}%
      \csname LTb\endcsname%%
      \put(6122,3583){\makebox(0,0)[r]{\strut{}$Ca=5 \times 10^{-2}$}}%
      \csname LTb\endcsname%%
      \put(6122,3310){\makebox(0,0)[r]{\strut{}$Ca=1 \times 10^{-2}$}}%
      \csname LTb\endcsname%%
      \put(6122,3037){\makebox(0,0)[r]{\strut{}$Ca=7.5 \times 10^{-3}$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{ratioDrag}}%
    \gplfronttext
  \end{picture}%
\endgroup
