...
# Legend
set key at 2.5,9e5 spacing 1.25
#set key Left
# Axes label 
set xlabel '$1/h^*$'
...
# Plot
plot 'dragFluid.txt' u 1:3 w lp ls 1 t '$Ca=1 \times 10^{0},wo$', \
'dragFluid.txt' u 1:2 w lp ls 11 t '$-,ow$', \
'dragFluid.txt' u 1:5 w lp ls 2 t '$Ca=5 \times 10^{-2},wo$', \
'dragFluid.txt' u 1:4 w lp ls 12 t '$-,ow$', \
'dragFluid.txt' u 1:7 w lp ls 3 t '$Ca=7.5 \times 10^{-3},wo$', \
'dragFluid.txt' u 1:6 w lp ls 13 t '$-,ow$'
