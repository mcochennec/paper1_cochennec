...
\begin{picture}(7200.00,4320.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(5991,1409){\makebox(0,0)[l]{\strut{}$2$}}%
    }%
    \gplgaddtomacro\gplfronttext{%
      \csname LTb\endcsname%%
      \put(153,2364){\rotatebox{-270}{\makebox(0,0){\strut{}$T_{cyl+pl}^x$}}}%
      \csname LTb\endcsname%%
      \put(4330,130){\makebox(0,0){\strut{}$1/h^*$}}%
      \csname LTb\endcsname%%
      \put(3515,3936){\makebox(0,0)[r]{\strut{}$Ca=1.0 \times 10^{0}$}}%
      \csname LTb\endcsname%%
      \put(3515,3657){\makebox(0,0)[r]{\strut{}$Ca=2.0 \times 10^{-1}$}}%
      \csname LTb\endcsname%%
      \put(3515,3378){\makebox(0,0)[r]{\strut{}$Ca=5.0 \times 10^{-2}$}}%
      \csname LTb\endcsname%%
      \put(3515,3099){\makebox(0,0)[r]{\strut{}$Ca=1.0 \times 10^{-2}$}}%
      \csname LTb\endcsname%%
      \put(3515,2820){\makebox(0,0)[r]{\strut{}$Ca=7.5 \times 10^{-3}$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{drag_solid-inc}}%
    \gplfronttext
  \end{picture}%
\endgroup
\end{document}
