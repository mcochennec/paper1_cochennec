...
# Plot
plot 'drag_plates.txt' u 1:2 w lp ls 1 t '$Ca=1 \times 10^{0},w$', \
'drag_plates.txt' u 1:3 w lp ls 11 t '$-,o$', \
'drag_plates.txt' u 1:6 w lp ls 2 t '$Ca=5 \times 10^{-2},w$', \
'drag_plates.txt' u 1:7 w lp ls 12 t '$-,o$', \
'drag_plates.txt' u 1:10 w lp ls 3 t '$Ca=7.5 \times 10^{-3},w$', \
'drag_plates.txt' u 1:11 w lp ls 13 t '$-,o$'
