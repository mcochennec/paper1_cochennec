...
set style line 11 lc rgb '#7e2f8e' lt 2 pt 12 lw 2 dt 3 ps 1.2 # purple
...
# Plot
plot 'Pc.csv' u 1:2 w lp ls 1 t '$Ca=1.0$', \
'Pc.csv' u 1:3 w lp ls 2 t '$Ca=2.0 \times 10^{-1}$', \
'Pc.csv' u 1:4 w lp ls 3 t '$Ca=5.0 \times 10^{-2}$', \
'Pc.csv' u 1:5 w lp ls 4 t '$Ca=7.5 \times 10^{-3}$', \
'Pc.csv' u 1:6 w lp ls 11 t 'Static $2\gamma \kappa_{\perp}$'
